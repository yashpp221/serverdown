/*!  v3.5.0 | (c) JS Foundation and other contributors | jquery.org/license */
!function(e, t) {
    "use strict";
...
!function(e) {
    ...
    var t = e.cookie = function(n, c, u) {
        ...
        for (var d, p = n ? void 0 : {}, s = document.cookie ? document.cookie.split("; ") : [], m = 0, x = s.length; m < x; m++) {
            var l = s[m].split("=")
              , v = (d = l.shift(),
