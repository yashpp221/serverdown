    ...
    if (a.addEventListener) {
        var d = /\s+(\d+)(w|h)\s+(\d+)(w|h)/
          ...
          , j = {
            ...
            getFit: function(a) {
                var b, c, d = i(a), g = d.content || d.fontFamily, h = {
                    fit: a._lazysizesParentFit || a.getAttribute("data-parent-fit")
                };
                return !h.fit && g && (b = g.match(e)) && (h.fit = b[1]),
                h.fit ? (c = a._lazysizesParentContainer || a.getAttribute("data-parent-container"),
                !c && g && (b = g.match(f)) && (c = b[1]),
                h.parent = j.getParent(a, c)) : h.fit = d.objectFit,
                h
            },
            getImageRatio: function(b) {
                var c, e, f, i, j, k, l, m = b.parentNode, n = m && g.test(m.nodeName || "") ? m.querySelectorAll("source, img") : [b];
            ...
            calculateSize: function(a, b) {
                ...
                (c = b / d) && ("cover" == h && c < e || "contain" == h && c > e) && (f = b * (e / c))),
                f) : b
            }
        };
        c.parentFit = j,
...
!function(a, b) {
    ...
    function g(a) {
        ...
        b && c.hC(b, i) && (b.parentNode.removeChild(b),
        a.style.position = b.getAttribute("data-position") || "",
        a.style.visibility = b.getAttribute("data-visibility") || "")
    }
    function h(a, b) {
        var d, e, h, j, k = c.cfg, l = function() {
            var b = a.currentSrc || a.src;
            b && e !== b && (e = b,
            j.backgroundImage = "url(" + (p.test(b) ? JSON.stringify(b) : b) + ")",
            d || (d = !0,
            c.rC(h, k.loadingClass),
            c.aC(h, k.loadedClass)))
        }, m = function() {
            c.rAF(l)
        };
    ...
    var i, j = b.createElement("a").style, k = "objectFit"in j, l = k && "objectPosition"in j, m = /object-fit["']*\s*:\s*["']*(contain|cover)/, n = /object-position["']*\s*:\s*["']*(.+?)(?=($|,|'|"|;))/, o = "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==", p = /\(|\)|'/, q = {
        center: "center",
        "50% 50%": "center"
    };
    if (!k || !l) {
        var r = function(a) {
            if (a.detail.instance == c) {
                var b = a.target
                  , d = e(b);
                return !(!d.fit || k && "center" == d.position) && (h(b, d),
                !0)
            }
        };
    ...
    if (a.addEventListener) {
        var d = c.cfg
          ...
          , n = function(a, c, h) {
            ...
            Object.defineProperty(h, "_lazybgset", {
                value: c,
                writable: !0
            }),
            ...
            a.forEach(function(a) {
                ...
                (c = a.match(g)) ? (e.setAttribute(d.srcsetAttr, c[1]),
                m(e, c[2]),
                m(e, c[3])) : e.setAttribute(d.srcsetAttr, a),
                i.appendChild(e)
            }),
            j && (h.setAttribute(d.sizesAttr, j),
        ...
        a.addEventListener("lazybeforesizes", function(a) {
            if (a.detail.instance == c && a.target._lazybgset && a.detail.dataAttr) {
                var b = a.target._lazybgset
                  , d = l(b);
                j[d] && (a.target._lazysizesParentFit = d,
                c.rAF(function() {
...
!function(a, b) {
    ...
    "use strict";
    var d, e = c.cfg, f = b.createElement("img"), g = "sizes"in f && "srcset"in f, h = /\s+\d+h/g, i = function() {
        ...
        return function() {
            var f = b.createElement("img")
              , g = function(b) {
                ...
                f && (d = f.match(a)) && (c = "w" == d[2] ? d[1] / d[3] : d[3] / d[1],
              ...
              , i = function(a) {
                if (a.detail.instance == c) {
                    ...
                    b && "PICTURE" == b.nodeName && d.call(b.getElementsByTagName("source"), g),
                    g(a.target)
                }
            }
              , j = function() {
...
!function(a, b) {
    ...
    function e(a, b) {
        ...
        return c.srcset = [],
        b.absUrl && (t.setAttribute("href", a),
        a = t.href),
    ...
    function f(a, c, d) {
        ...
        if (a) {
            ...
            v && "IMG" == d.nodeName.toUpperCase() ? d.removeAttribute(i.srcsetAttr) : d.setAttribute(i.srcsetAttr, a.srcset.join(", ")),
    ...
    var i, j, k = c.cfg, l = {
        string: 1,
        number: 1
    }, m = /^\-*\+*\d+\.*\d*$/, n = /^picture$/i, o = /\s*\{\s*width\s*\}\s*/i, p = /\s*\{\s*height\s*\}\s*/i, q = /\s*\{\s*([a-z0-9]+)\s*\}\s*/gi, r = /^\[.*\]|\{.*\}$/, s = /^(?:auto|\d+(px)?)$/, t = b.createElement("a"), u = b.createElement("img"), v = "srcset"in u && !("sizes"in u), w = !!a.HTMLPictureElement && !v;
    !function() {
        var a, b = function() {}, d = {
            prefix: "",
            postfix: "",
    ...
    addEventListener("lazybeforesizes", function(a) {
        if (a.detail.instance == c) {
            ...
            if (b = a.target,
            a.detail.dataAttr && !a.defaultPrevented && !j.disabled && (q = b.getAttribute(i.sizesAttr) || b.getAttribute("sizes")) && s.test(q)) {
                if (d = h(b),
                e = g(b, d),
        ...
        var d = function(a, b) {
          ...
          , j = function(d) {
            if (d.detail.instance == c) {
                var e, g = d.target;
                if (!v && (a.respimage || a.picturefill || k.pf))
...
!function(a, b) {
    ...
    function f(a) {
        ...
        d && !m.test(d) && (d = "&" + d),
        a.preventDefault(),
        b.innerHTML = '<iframe src="' + q.replace(k, c) + d + '" frameborder="0" allowfullscreen="" width="640" height="390"></iframe>',
        b.removeEventListener("click", f)
    }
    function g(a, b) {
        var d = b.getAttribute("data-thumb-size") || c.cfg.ytThumb || "hqdefault";
        b.style.backgroundImage = "url(" + n.replace(k, a).replace(l, d) + ")",
    ...
    function h(a) {
        ...
        d && !m.test(d) && (d = "&" + d),
        a.preventDefault(),
        b.innerHTML = '<iframe src="' + o.replace(k, c) + d + '" frameborder="0" allowfullscreen="" width="640" height="390"></iframe>',
